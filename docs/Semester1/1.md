...
# Hands-on
You are pursuing a computer degree, so you will have a 'hands-on' class that will allow you to apply the theories you are learning in practical situations. You will find this mini table after each semester table, which includes the subjects with which you are having practical classes and exams.
 |Subject    | Software    |
|:--------                     |:--------:                    | 
