...
# Hands-on
 |Subject    | Software    |
|:--------                     |:--------:                    | 
| Computer security|  [openSSL](https://www.openssl.org/source/) |
|Embedded systems |    |
|Dynamic web programming |   [vs code]()|
|SAO architecture and web service|[XML]()|
|Unix Systems Administration|[virtual box](https://www.virtualbox.org/wiki/Downloads),[centos](https://www.centos.org/download/)|
|Network Administration|[virtual box](https://www.virtualbox.org/wiki/Downloads),[centos](https://www.centos.org/download/)|
|Administration windows systems|[virtual box](https://www.virtualbox.org/wiki/Downloads),[windows server 2008]()|
