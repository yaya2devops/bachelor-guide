...
IoT architecture involves understanding the fundamentals of IoT, IBM Cloud, IBM Zaston, and NODE-RED.
...
IoT security focuses on security concepts, security fundamentals, blockchain, and smart contracts.
...
Wireless networking technology for IoT covers general wireless network concepts, methods of transmission in wireless networks, characterization of the channel transmission in communications wireless, local networks without wire (WIFI), and cellular networks (GSM, GPRS, UMTS).
...
Embedded Linux involves introduction to embedded Linux, GNU and Linux, overview of the system, Linux distros, user login, and emulating the Raspberry Pi under Ubuntu with Qemu.
...
Preparation for the professional environment involves career success, oral and written communication, and team management.
